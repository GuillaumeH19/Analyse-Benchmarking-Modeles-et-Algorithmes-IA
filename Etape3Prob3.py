...
chemin_fichier = "DEMO_Tusar_bbob-biobj/d05/1-separable_1-separable/bbob-biobj_f11_d05_hyp.tdat"
df2 = ouvrirfichier(chemin_fichier)

chemin_fichier = "RANDOMSEARCH-5_Auger_bbob-biobj/d05/1-separable_1-separable/bbob-biobj_f11_d05_hyp.tdat"
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape3/Prob3/graphe_instance_1.png')
plt.show()
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape3/Prob3/graphe_instance_all.png')
plt.show()
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape3/Prob3/graphe_instance_agregated.png')
plt.show()