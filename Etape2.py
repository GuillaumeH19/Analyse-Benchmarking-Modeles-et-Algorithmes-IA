...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape2/graphe_instance_1.png')
plt.show()
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape2/graphe_instance_all.png')
plt.show()
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape2/graphe_instance_agregated.png')
plt.show()