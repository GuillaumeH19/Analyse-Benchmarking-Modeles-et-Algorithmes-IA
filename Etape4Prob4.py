...
chemin_fichier = "DEMO_Tusar_bbob-biobj/d05/3-ill-conditioned_4-multi-modal/bbob-biobj_f37_d05_hyp.tdat"
df2 = ouvrirfichier(chemin_fichier)

chemin_fichier = "RANDOMSEARCH-5_Auger_bbob-biobj/d05/3-ill-conditioned_4-multi-modal/bbob-biobj_f37_d05_hyp.tdat"
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape4/Prob4/graphe_instance_1.png')
plt.show()
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape4/Prob4/graphe_instance_all.png')
plt.show()
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape4/Prob4/graphe_instance_agregated.png')
plt.show()