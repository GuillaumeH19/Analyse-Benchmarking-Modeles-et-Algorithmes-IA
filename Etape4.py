...
plt.plot(df_instance_3['function evaluation'], df_instance_3['indicator value'], marker='o', linestyle='',markersize=5, label=f'1-separable_2-moderate', color='green')
plt.plot(df_instance_4['function evaluation'], df_instance_4['indicator value'], marker='o', linestyle='',markersize=5, label=f'3-ill-conditioned_4-multi-modal', color='orange')
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape4/graphe_instance_1.png')
plt.show()
...
for instance in instances:
    ...
    plt.plot(df_instance4['function evaluation'], df_instance4['indicator value'], marker='o', linestyle='',markersize=3, label=label_prob4,color='orange')
    label_prob1 = ''
    label_prob2 = ''
    label_prob3 = ''
    label_prob4 = ''
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape4/graphe_instance_all.png')
plt.show()
...
plt.plot(df_aggregated3['function evaluation'], df_aggregated3['median'], label='1-separable_2-moderate', color='green')
...
plt.plot(df_aggregated4['function evaluation'], df_aggregated4['median'], label='3-ill-conditioned_4-multi-modal', color='orange')
plt.fill_between(df_aggregated4['function evaluation'], df_aggregated4['min'], df_aggregated4['max'], alpha=0.5, color='orange', label='Min-Max Range')
...
plt.yscale('log')
plt.legend()
plt.savefig('Graphes/Etape4/graphe_instance_agregated.png')
plt.show()
